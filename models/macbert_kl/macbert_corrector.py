...
sys.path.append('../..')
from model_corrector_equal.utils.text_utils import convert_to_unicode
# from model_corrector_equal.utils.logger import logger
from pycorrector import config
from model_corrector_equal.utils.tokenizer import split_text_by_maxlen
...
class MacBertCorrector(object):
    def __init__(self, macbert_model_dir=config.macbert_model_dir):
        ...
        logger.debug('Loaded macbert_ model: %s, spend: %.3f s.' % (macbert_model_dir, time.time() - t1))
